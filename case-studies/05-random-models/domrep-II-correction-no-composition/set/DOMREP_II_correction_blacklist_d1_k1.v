...
// Date      : Wed Sep  4 19:55:22 2024
/////////////////////////////////////////////////////////////


module DOMREP_II_toTest_toBlacklist ( port_a_0, port_a_1, port_b_0, port_b_1, 
        port_c, port_r_dom, port_r_rep, clk, reset );
  input [2:0] port_a_0;
  input [2:0] port_a_1;
  input [2:0] port_b_0;
  input [2:0] port_b_1;
  ...
  wire   [2:0] secrep_port_c_0;
  wire   [2:0] secrep_port_c_1;
  wire   [2:0] dom_comp_1;
  wire   [2:0] dom_comp_0;
  ...
  INV_X1 secrep_U12 ( .A(secrep_andDOM_29_port_c_0_0_), .ZN(secrep_port_c_0[2]) );
  INV_X1 secrep_U11 ( .A(secrep_andDOM_24_port_c_0_0_), .ZN(secrep_port_c_0[1]) );
  INV_X1 secrep_U10 ( .A(secrep_andDOM_19_port_c_0_0_), .ZN(secrep_port_c_0[0]) );
  ...
  XOR2_X1 secrep_xor_10_U1 ( .A(port_r_rep[0]), .B(dom_port_c_0[0]), .Z(
        secrep_refreshed_0[0]) );
  XOR2_X1 secrep_xor_11_U1 ( .A(port_r_rep[0]), .B(dom_port_c_1[0]), .Z(
        secrep_refreshed_1[0]) );
  XOR2_X1 secrep_xor_12_U1 ( .A(port_r_rep[1]), .B(dom_port_c_0[1]), .Z(
        secrep_refreshed_0[1]) );
  XOR2_X1 secrep_xor_13_U1 ( .A(port_r_rep[1]), .B(dom_port_c_1[1]), .Z(
        secrep_refreshed_1[1]) );
  XOR2_X1 secrep_xor_14_U1 ( .A(port_r_rep[2]), .B(dom_port_c_0[2]), .Z(
        secrep_refreshed_0[2]) );
  XOR2_X1 secrep_xor_15_U1 ( .A(port_r_rep[2]), .B(dom_port_c_1[2]), .Z(
  ...
  XOR2_X1 xor_backlist_0_U1 ( .A(secrep_port_c_1[0]), .B(secrep_port_c_0[0]), 
        .Z(port_c[0]) );
  XOR2_X1 xor_backlist_1_U1 ( .A(secrep_port_c_1[1]), .B(secrep_port_c_0[1]), 
        .Z(port_c[1]) );
  XOR2_X1 xor_backlist_2_U1 ( .A(secrep_port_c_1[2]), .B(secrep_port_c_0[2]), 
        .Z(port_c[2]) );
endmodule
